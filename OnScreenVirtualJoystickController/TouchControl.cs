...
namespace OnScreenController
{
    ...
    public partial class TouchControl : ShapeControl.CustomControl1
    {
        int count = 0;
        public TouchControl()
        {
        ...
        private void OnLoadHandler(Object sender, EventArgs e)
        {
            try
            {
                ...
                if (!RegisterTouchWindow(this.Handle, 1 | 2))
                {
        ...
        private bool DecodeTouch(ref Message m)
        {
            ...
            inputCount = inputCount > 3 ? 3 : inputCount;
